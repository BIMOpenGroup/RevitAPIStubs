...
Я не стал делать форк его репозитория потому что хочу внести кардинальные изменения,
...
Для максимальной эффективности заглушек их надо допиливать руками, но об этом подробней в примерах.  
